...
/** Catalogue démarrage maquis — quantités à 0 (le propriétaire compte ensuite). Noms alignés AU GBAISSAI CHEZ RCO pour les images. */
const MAQUIS: SeedProduct[] = [
  { name: 'BOCK 66', category: 'Bière', unit: 'Bouteille 65cl', stock: 0, min_stock: 12, cost: 450, price: 600 },
  { name: 'Castel 33cl', category: 'Bière', unit: 'Bouteille 33cl', stock: 0, min_stock: 12, cost: 400, price: 550 },
  { name: 'Beauford 50cl', category: 'Bière', unit: 'Bouteille 50cl', stock: 0, min_stock: 12, cost: 450, price: 650 },
  { name: 'Beauford 33cl', category: 'Bière', unit: 'Bouteille 33cl', stock: 0, min_stock: 12, cost: 500, price: 700 },
  { name: 'Despe', category: 'Bière', unit: 'Bouteille 33cl', stock: 0, min_stock: 6, cost: 700, price: 1000 },
  { name: 'Flag', category: 'Bière', unit: 'Bouteille 50cl', stock: 0, min_stock: 12, cost: 400, price: 550 },
  { name: 'Dopel / bières locales', category: 'Bière', unit: 'Bouteille', stock: 0, min_stock: 12, cost: 350, price: 500 },
  { name: 'Racine bièrre', category: 'Bière', unit: 'Bouteille', stock: 0, min_stock: 12, cost: 400, price: 550 },
  { name: 'racine fort bièrre', category: 'Bière', unit: 'Bouteille', stock: 0, min_stock: 12, cost: 450, price: 600 },
  { name: 'Codis bières blanc', category: 'Bière', unit: 'Casier', stock: 0, min_stock: 2, cost: 8000, price: 10000 },
  { name: 'Codis bières bleu', category: 'Bière', unit: 'Casier', stock: 0, min_stock: 2, cost: 8000, price: 10000 },
  ...
  { name: 'Sprite canette', category: 'Boisson', unit: 'Canette 33cl', stock: 0, min_stock: 12, cost: 200, price: 350 },
  { name: 'WordCola', category: 'Boisson', unit: 'Bouteille 33cl', stock: 0, min_stock: 24, cost: 200, price: 350 },
  { name: 'Mirinda orange canette', category: 'Boisson', unit: 'Canette', stock: 0, min_stock: 12, cost: 200, price: 350 },
  { name: 'Orangina', category: 'Boisson', unit: 'Bouteille', stock: 0, min_stock: 12, cost: 300, price: 500 },
  { name: 'CHILL', category: 'Boisson', unit: 'Canette', stock: 0, min_stock: 12, cost: 250, price: 400 },
  { name: 'Tonic', category: 'Boisson', unit: 'Bouteille', stock: 0, min_stock: 12, cost: 200, price: 350 },
  { name: 'Youki Pomme', category: 'Boisson', unit: 'Bouteille', stock: 0, min_stock: 12, cost: 250, price: 400 },
  { name: 'Énergie boom canette', category: 'Énergie', unit: 'Canette', stock: 0, min_stock: 12, cost: 300, price: 500 },
  { name: 'Codis énergie', category: 'Énergie', unit: 'Canette', stock: 0, min_stock: 12, cost: 300, price: 500 },
  { name: 'Rhino', category: 'Énergie', unit: 'Canette', stock: 0, min_stock: 12, cost: 350, price: 550 },
  { name: 'Vody vodka mix 18%', category: 'Spiritueux', unit: 'Canette 33cl', stock: 0, min_stock: 12, cost: 400, price: 600 },
  { name: 'OKALAMAR', category: 'Spiritueux', unit: 'Bouteille', stock: 0, min_stock: 6, cost: 1500, price: 2500 },
  { name: 'KAPA', category: 'Spiritueux', unit: 'Bouteille', stock: 0, min_stock: 6, cost: 1200, price: 2000 },
  { name: 'Chamberi', category: 'Vin', unit: 'Bouteille', stock: 0, min_stock: 4, cost: 1500, price: 2500 },
  { name: 'VIN MOELIEUX RLG', category: 'Vin', unit: 'Bouteille', stock: 0, min_stock: 4, cost: 2000, price: 3500 },
  { name: 'VIN VALPIERE PETIT FORMAT', category: 'Vin', unit: 'Bouteille', stock: 0, min_stock: 4, cost: 1500, price: 2500 },
  { name: 'VIN VALPIERRE GRAND FORMAT', category: 'Vin', unit: 'Bouteille', stock: 0, min_stock: 2, cost: 3000, price: 5000 },
  { name: 'Tropial', category: 'Boisson', unit: 'Bouteille', stock: 0, min_stock: 12, cost: 250, price: 400 },
